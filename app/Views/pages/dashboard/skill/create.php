    ...
    <div class="container">
        <div class="card shadow">
            <div class="card-header">
                <h4>Add Certificate Details <a href="<?= route_to('certificates') ?>" class="btn btn-info ml-2"><i class="fas fa-arrow-left"></i> Kembali</a></h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="certificate_name" placeholder="Enter Certificate Name" value="">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" name="year" placeholder="Certification Year" value="">
                                <div class="invalid-feedback">
